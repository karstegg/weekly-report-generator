...
export const reportData: ReportData = {
  ...
  heal: {
    ...
    lowlights: [
      ...
      { site: 'Gloria', text: 'Wrong diverted actuator delivered' },
    ],
    emergingIssues: [
  ...
  sites: {
    nchwaning3: {
      name: 'Nchwaning 3',
      trendChart: { src: '/images/N3 Weekly availability chart.png', comment: '"Fleet average at 83%. DT at 76%, FL at 77%, HD at 87%, RT at 81%, SR at 79%."' },
      ...
      breakdowns: [
          ...
          { category: 'Road Trucks (81%)', details: 'RT47 Radiator, RT51 Compressor' },
          { category: 'Scalers (79%)', details: 'SR35 Engine Smoke, SR26 Boom Cylinder Broken, SR51 Fire Supp, SR38 Boom Nuts Broken' },
      ],
    ...
    gloria: {
        name: 'Gloria',
        trendChart: { src: '/images/Gloria Weekly availability Chart.png', comment: '"Fleet average at 87%. DT at 79%, FL at 77%, HD at 90%, RT at 91%, SR at 97%."' },
        safety: { status: 'Good', details: 'Zero incidents this week' },
        ...
        breakdowns: [
          { category: 'Dump Trucks (79%)', details: 'DT Diesel at 79%' },
          { category: 'Front Loaders (77%)', details: 'FL0093 Steering' },
          { category: 'Haul Dumps (90%)', details: 'HD0066 Service 07/03/2026' },
        ],
