...
export const reportData: ReportData = {
  ...
  sites: {
    nchwaning3: {
      ...
      footerNote: 'Combined DT availability (Diesel 73% + BEV 84%) = 78%. Combined FL (Diesel 65% + BEV 83%) = 74%. MTD Fleet Average: 82.57%',
    },
    nchwaning2: {
        name: 'Nchwaning 2',
    ...
    gloria: {
        ...
        safety: { status: 'Good', details: 'Zero incidents this week' },
        weeklyAverage: { value: 88.00, target: 85 },
        ...
        breakdowns: [
            { category: 'Dump Trucks (77%)', details: 'FL0093 Steering' },
            { category: 'Front Loaders (86%)', details: 'HD0066 Service 07/03/2026' },
        ],
        footerNote: 'MTD Fleet Average: 88.00%. CV0052 safe line breakdowns continue.',
    },
  },
  bev: {
    availability: [
