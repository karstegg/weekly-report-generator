...
export const reportData: ReportData = {
  ...
  heal: {
    highlights: [
        { site: 'N2', text: 'The trucks are back to full fleet with DT0121 finally fixed' },
        ...
        { site: 'GLA', text: 'Removal of axle from UV0128 to UV0068 was completed safely and two changing emulsion available' },
    ...
    lowlights: [
        ...
        { site: 'N2', text: 'Backlog on OEM legal Work orders' },
        { site: 'N3', text: 'Poor availabilities on HDs' },
        { site: 'GLA', text: 'Raise compressor failure causing pressure drop resulting SMS not to shotcrete in 9 West section' },
        { site: 'GLA', text: 'DTs availability was 69%' },
        { site: 'GLA', text: 'DT0105 & 106 on breakdown relating to Nerospec and still not fixed yet' },
        { site: 'GLA', text: 'DT0173 - Jumping gears' },
    ],
    emergingIssues: [
        { site: 'N2', text: '28N electrical trip out are impacting smooth production' },
        { site: 'N2', text: 'Loading points' },
        { site: 'N2', text: 'FL114 breakdown on the face caused lost blast on 3 faces' },
        { site: 'N3', text: 'LDV/UV Strata related & allocations' },
        { site: 'N3', text: 'Spares issues (Scaler Engines, S2 axles)' },
    ...
    priorities: [
        ...
        { site: 'N3', text: 'High profile visit' },
        { site: 'GLA', text: '74N tip CAP liners to be repairs – two outstanding' },
        { site: 'GLA', text: 'CV0053 and 51H to be hot spliced' },
        { site: 'GLA', text: 'Waiting delivery of diverted actuator for HG and LG' },
        { site: 'GLA', text: 'Zennith to service raise compressor' },
    ],
  },
  shaftsAndWinders: {
  ...
  sites: {
    nchwaning3: {
      name: 'Nchwaning 3',
      trendChart: { src: '/images/N3 Weekly availability chart.png', comment: '"Poor HD availability at 77%. DT Diesel at 72%, FL Diesel at 40%. BEV performance improved."' },
      safety: { status: 'Good', details: 'Zero incidents this week' },
      weeklyAverage: { value: 75, target: 85 },
      serviceCompliance: { status: 'Good', details: 'All equipment at 100% compliance' },
      availability: [
          { label: 'DT', percentage: 76, target: 85 },
          { label: 'FL', percentage: 65, target: 85 },
          { label: 'HD', percentage: 77, target: 85 },
          { label: 'RT', percentage: 87, target: 85 },
          { label: 'SR', percentage: 80, target: 85 },
      ],
      breakdowns: [
          { category: 'Dump Trucks (76%)', details: 'DT148: Aircon/Mainswitch, DT154: Engine not starting, DT145: Gears, DT160: Strata' },
          { category: 'Front Loaders (65%)', details: 'FL101: Steering, FL103: Not Starting' },
          { category: 'Hydraulic Drills (77%)', details: 'HD49: Propshaft, HD61: ECM engine check, HD55: Door & Window damaged' },
          { category: 'Scalers (80%)', details: 'SR35: Engine smoke, SR24: Aircon, SR39: Brakes Faulty' },
      ],
      footerNote: 'Combined DT availability (Diesel + BEV) at 76%. FL Diesel critically low at 40% due to FL101 steering and FL103 not starting. HD availability impacted by propshaft and ECM issues. BEV DT at 81%, BEV FL at 90%.',
    },
    nchwaning2: {
        name: 'Nchwaning 2',
        ...
        availability: [
            ...
            { label: 'FL', percentage: 83, target: 85 },
    ...
    gloria: {
        name: 'Gloria',
        trendChart: { src: '/images/Gloria Weekly availability Chart.png', comment: '"Good improvement in RTs and HDs for three weeks. DT availability at 69%. All CAT trucks available."' },
        safety: { status: 'Good', details: 'Zero incidents this week' },
        weeklyAverage: { value: 88, target: 85 },
        ...
        breakdowns: [
            { category: 'Dump Trucks (69%)', details: 'DT0105 & DT0106: Nerospec issues, DT0173: Jumping gears' },
            { category: 'Roof Bolters (86%)', details: 'RT0045: Power trip, RT0046/RT0060 issues' },
        ],
  ...
  utilitySection: {
    fleetStatus: { available: 61, unavailable: 3 },
    areaSummary: [
    ...
    dailyTracking: [
      ...
      { area: 'TOTAL', mon: { available: 61, total: 65, color: 'green' }, tue: { available: 61, total: 65, color: 'green' }, wed: { available: 61, total: 65, color: 'green' }, thu: { available: 61, total: 65, color: 'green' }, fri: { available: 61, total: 65, color: 'green' }, weeklyAvg: 93.8 },
    ],
  },
  utilitySectionCurrentStatus: {
    totalUnavailable: 3,
